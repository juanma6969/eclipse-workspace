		...
		ModeloInterface modelo= (ModeloInterface) contexto.getBean("modelo");
		 ...
		 @Override
		    ...
		    protected void doPost(HttpServletRequest request, HttpServletResponse response)
		       ...
		       modelo.consultaUP(userParam, passParam);
		        // Verificamos en la BD, si es un usuario correcto.
		        Usuario usuario = modelo.consultaUP(userParam, passParam);
		    ...
		    private void eliminarServidor(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		        ...
		        boolean respuesta = modelo.bajaS(idServidorParam);
		        String msg = "";
		        if (respuesta ) { // Fue afectado un registro, esto significa que si se borro
